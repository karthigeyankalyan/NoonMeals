...
def render_individual_employees(_id):
    ...
    single_employee_dict = Database.find_one("employees", {'_id': ObjectId(_id)})

    if single_employee_dict is None:
        single_employee_dict = Database.find_one("employees", {'_id': _id})
